...
- Federal Reserve: the US Federal Reserve, FOMC, US interest rates, US monetary policy, Fed officials, Fed governors, Fed chair, or any current voting FOMC member. Valid signals include: "the Fed", "Fed's", "Fed said", "Fed officials", "Fed governors", "rate cut", "rate hike", "basis points", or any of the following FOMC member last names: Powell, Williams, Barr, Bowman, Cook, Hammack, Jefferson, Kashkari, Logan, Miran, Paulson, Waller. If an article mentions any of these individuals in the context of monetary policy, interest rates, or central banking, tag it as Federal Reserve. NOTE: Do NOT tag articles where "fed" is used in a non-Federal-Reserve context such as "FedEx", "fed up", "has been fed", or similar unrelated usages. Do NOT tag solely because a name like "Barr" or "Cook" appears — it must be in a Federal Reserve / monetary policy context. When in doubt, ask: is this article about US central bank policy or officials? If yes, tag it. If no, do not.
