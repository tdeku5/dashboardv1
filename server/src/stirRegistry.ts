...
export const STIR_MARKETS: StirMarket[] = [
  ...
  },
  {
    ...
    rateLabel: 'CURRENT BANK RATE',
    tickerPrefix: 'SO3',
    cadence: 'quarterly',
    yearDigits: 1,
    anchorSource: { type: 'static', value: 4.50 },
    centralBank: 'BOE',
  },
  {
    marketKey: 'EUR',
    ...
    rateLabel: 'CURRENT ECB RATE',
    tickerPrefix: 'EUR',
    cadence: 'quarterly',
    yearDigits: 1,
    anchorSource: { type: 'static', value: 3.25 },
    centralBank: 'ECB',
  },
  {
    marketKey: 'CRA',
    ...
    cadence: 'quarterly',
    yearDigits: 1,
    anchorSource: { type: 'static', value: 3.00 },
    centralBank: 'BOC',
  },
  {
    marketKey: 'TOA3',
    ...
    cadence: 'quarterly',
    yearDigits: 1,
    anchorSource: { type: 'static', value: 0.50 },
    centralBank: 'BOJ',
  },
  {
    marketKey: 'AUS',
